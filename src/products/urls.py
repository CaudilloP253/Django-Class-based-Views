...
from products.views import ProductDetailView, ProductListView, DigitalProductListView, ProductIDRedirectView, ProtectedProductDetailView ProductRedirectView
